...
Original file is located at
    https://colab.research.google.com/drive/1XTiblSHFXNuT05LipO8Ul9zebjZq0Ka4
"""
...
for epoch in range(num_epochs):
    for i, (images, labels) in enumerate(data_loader):
        ...
        z = noise(batch_size)
        fake_labels_ = torch.randint(0, num_classes, (batch_size,)).to(device)
        fake_images = G(z, fake_labels_)
        outputs = D(fake_images, fake_labels_)
